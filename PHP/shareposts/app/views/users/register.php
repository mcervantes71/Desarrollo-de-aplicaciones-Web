            ...
            <div class="card card-body bg-light mt-5">
                ...
                <form action="<?php echo URL_ROOT; ?>/users/register" method="POST">
                    <div class="form-group">
                        ...
                        <input name="name" class="form-control form-control-lg <?php echo(!empty($data['name_error']))?'is-invalid':'';?>" type="text" value="<?php echo $data['name']; ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input name="confirm_password" class="form-control form-control-lg <?php echo(!empty($data['confirm_password_error']))?'is-invalid':'';?>" type="password" value="<?php echo $data['confirm_password']; ?>">
