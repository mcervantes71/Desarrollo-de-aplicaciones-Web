...
public class _03_Integer_Numeric_Primitives
{
    public static void main(String[] args)
    {
        long max = 32_123_456_789L;

        // long n = _2      // does not compile
        // long n = 2_.0    // does not compile
        // long n = 20._0   // does not compile
        // long n = 20.10_  // does not compile
