        ...
        <div class="container">
            ...
            <%
                try
                {
                    ...
                    String  comando = "SELECT * FROM Leave_requests WHERE leave_request_id =" + id;
                    ...
                    out.println("<form action='solicitud_modificar.jsp' method='POST'>" +
                            ...
                            "<div class='form-group'>" +
                                ...
                                "<input type='date' class='form-control' name='start_date' value='" + resultado.getString("start_date") + "' />" +
                            "</div>" +
                            "<div class='form-group'>" +
                                "<label for='end_date'>Fecha del &uacute;ltimo d&iacute;a</label>" +
                                "<input type='date' class='form-control' name='end_date' value='" + resultado.getString("end_date") + "' />" +
                            "</div>" +
                            "<div class='form-group'>" +
                                "<label for='return_date'>Fecha de regreso</label>" +
                                "<input type='date' class='form-control' name='return_date' value='" + resultado.getString("return_date") + "' />" +
                            "</div>" +
                            "<div class='form-group'>" +
