                        ...
                        while($rows = $resultado->fetch_assoc())
                        {
                            ...
                            echo "<form action='empleado_modificar.php' method='POST'>
                                    ...
                                    <div class='form-group'>
                                        ...
                                        <input type='text' class='form-control' name='first_name' value='".$rows["first_name"]."' />
                                    </div>
                                    <div class='form-group'>
                                        <label for='last_name'>Apellido</label>
                                        <input type='text' class='form-control' name='last_name' value='".$rows["last_name"]."' />
                                    </div>
                                    <div class='form-group'>
                                    ...
                                    <div class='form-group'>
                                        ...
                                        <input type='text' class='form-control' name='manager' value='".$rows["manager"]."' />
                                    </div>
